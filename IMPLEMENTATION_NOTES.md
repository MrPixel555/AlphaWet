...
- JNI/nativeLibraryDir binary packaging for `arm64-v8a` and `x86_64` via `tool/prepare_android_runtime.sh`
...
- ICMP-style RTT or multi-hop diagnostics beyond the HTTP latency probe
