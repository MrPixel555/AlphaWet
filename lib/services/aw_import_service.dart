...
class AwImportService {
  ...
  static const String _transportKeyBase64 = String.fromEnvironment(
    'AW_TRANSPORT_KEY_BASE64',
    defaultValue: 'Lln2izWgmkJPMLKq+nMA+1Vih/xnPT7LE0dF3BQYpdA=',
  );
  static const String _ed25519PublicKeyBase64 = String.fromEnvironment(
    'AW_ED25519_PUBLIC_KEY_BASE64',
    defaultValue: 'NDVhsX56Lwesg4NaXmHyqA2vGxte/3q7vxx7ny/QKL4=',
  );
